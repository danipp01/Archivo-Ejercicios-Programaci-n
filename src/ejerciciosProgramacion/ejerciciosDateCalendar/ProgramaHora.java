...
public class ProgramaHora {
	...
	public static void main(String[] args) {
		...
		String strFecha = JOptionPane.showInputDialog("Indica una fecha: ");
		Calendar calendar = Calendar.getInstance();
		Date fecha = null;
		
		try {
			fecha = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss").parse(strFecha);
		...
		System.out.println("La fecha introducida por el usuario esç: " + strFecha);
